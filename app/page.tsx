...
const events = [
  {
    image: '/unical.jpg',
    title: 'Techvantage UNICAL / WorkShop',
    ...
    date: 'July 3rd, 2024',
    time: '12:00 PM',
    location: 'Cross River Community Town Hall, UNICAL',
    link: 'https://forms.gle/Q9ARgJvjV7V8Ttyr8',
    status: 'upcoming'
  },
  {
    image: '/2052.jpg',
    title: 'Techvantage UNICROSS BootCamp',
    description: 'JTransform your skills in just days! TechVantage Bootcamp is an intensive, hands-on training program. Learn from industry experts, work on real-world projects, and launch your career in tech. Limited spots available!',
    date: 'Comming Soon',
    time: 'Comming Soon',
  ...
  },
  {
    ...
    date: 'June 6th, 2024',
    time: '9:00 AM',
    location: 'New Cafe Hall UNICROSS, Calabar South, CRS Nigeria',
